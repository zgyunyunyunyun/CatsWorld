...
public class NewCatController : MonoBehaviour//虽然这里写新增小猫，但对玩家是探索、寻找
{
    ...
    public int consumeStone = 100;//下一次消耗的灵石数量

    public int time = 0;//当前第几次诞生小猫
    ...
    void Update()
    {
        ...
        if (MainController.instance.isFirstTimeGaming)
        {
            ...
            isFree = true;
            freeTipsText.text = "首次玩游戏，可免费寻找" + freeNewTime.ToString() + "次小猫";
        ...
        else
        {
            ...
            }else
            {
                ...
                if(shareTime > 0)
                {
                    freeTimeText.text = hour + ":" + minute + ":" + second + " 后免费，每日可<color=#F32D2D>分享</color>3次重置免费";
    ...
    public void Share()
    {
        WX.ShareAppMessage(new ShareAppMessageOption
        {
            ...
            title = "嘿嘿，我马上就能找到" + outCatNumber.ToString() + "只猫猫了", // 显示文本
